    ...
    <script type="text/javascript">
        function cclick(price, id) {
            ...
            if (pic <= price) {
                ...
                location = "${pageContext.request.contextPath}/updatepic.do?auction_id=" + id + "&auction_upset=" + pic;
                $("#p").html("");
            }
        }

        function checkRefresh(id) {
            location = "${pageContext.request.contextPath}/selectOnee.do?auction_id=" + id;
        }

        function checkMain() {
            location = "${pageContext.request.contextPath}/selectAll.do";
        }
    </script>
</head>
...
<div class="wrap">
    ...
    <div class="sale">
        ...
        <div class="logout right"><a href="/p/remove.do" title="注销">注销</a></div>
    </div>
    ...
    <div class="rg borders">
        <img src="${pageContext.request.contextPath}/images/${auction.auction_pic }" width="270" height="185" alt=""/>
    </div>
    <div class="cl"></div>
