...
<div class="wrap">
    ...
    <form action="${pageContext.request.contextPath}/add.do" method="post" onsubmit="return checkForm()" enctype="multipart/form-data">
        <div class="sale">
        ...
        <div class="login logns produce">
            ...
            <dl>
                ...
                <dd>
                    <label>开始时间：</label>
                    <input type="text" class="inputh lf" name="auction_start_time" onblur="checkStartTime()"
                           id="startTime"/>
                    <div class="lf red laba"></div>
                </dd>
                <dd>
                ...
                <dd class="dds">
                    <label>描述：</label>
                    <textarea name="auction_desc" cols="" rows="" class="textarea" onblur="checkText()"
                              id="tt"></textarea>
                </dd>
                <dd class="hegas">
