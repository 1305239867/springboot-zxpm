                ...
                <div class="login">
                    <dl>
                        ...
                        <dd>
                            ...
                            <span class="wordp lf"><img src="${pageContext.request.contextPath}/getKaptcha.do" width="96" height="27"
                                                        id="kaptchaImage"/></span>
                            <span class="blues lf"><a href="javascript:void(0)"
                                                      onclick="changeImage()">看不清?换一张</a></span>
                        </dd>
                        <dd class="buttom">
