            ...
            <ul class="rows">
                ...
                <li class="borderno red">
                    <c:if test="${user.user_is_admin==0 }">
                        <a href="${pageContext.request.contextPath}/selectOnee.do?auction_id=${a.auction_id}">竞拍</a>
                    </c:if>
                    <c:if test="${user.user_is_admin==1 }">
                        <a href="${pageContext.request.contextPath}/selectOnee.do?auction_id=${a.auction_id}">竞拍</a>
                        <a href="javascript:void(0)" title="修改" onclick="dele(${a.auction_id })">修改</a>|

                        <a href="${pageContext.request.contextPath}/delete.do?auction_id=${a.auction_id }&auction_pic=${a.auction_pic  }"
                           title="删除">删除</a>
                    </c:if>
                </li>
