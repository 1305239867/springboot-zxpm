...
public class AuctionController {
    ...
    public String selectAll(Map map, String auction_name, String auction_desc, Date auction_start_time, Date auction_end_time, Double auction_start_price) {
        List<Auction> list = auctionService.selectAll(auction_name, auction_desc, auction_start_time, auction_end_time, auction_start_price);
        map.put("list", list);
        return "manage";
    }
